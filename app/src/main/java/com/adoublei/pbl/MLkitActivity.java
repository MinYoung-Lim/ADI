...
public class MLkitActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_m_lkit);

        textView = findViewById(R.id.text);
        button = findViewById(R.id.selectImage);
        imageView = findViewById(R.id.image);

        progressDialog = new ProgressDialog(MLkitActivity.this);
    ...
    private void setLabelerFromLocalModel(Uri uri) {
        ...
        try {
            ...
            image = FirebaseVisionImage.fromFilePath(MLkitActivity.this, uri);
    ...
    private void setLabelerFromRemoteLabel(final Uri uri) {
        FirebaseModelManager.getInstance().isModelDownloaded(remoteModel)
                    ...
                    public void onComplete(@NonNull Task<Boolean> task) {
                        if (task.isComplete()) {
                            ...
                            try {
                                ...
                                Toast.makeText(MLkitActivity.this, "Ml exeception", Toast.LENGTH_SHORT).show();
                            }
                        } else
                            Toast.makeText(MLkitActivity.this, "Not downloaded", Toast.LENGTH_SHORT).show();
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(MLkitActivity.this, "err"+e, Toast.LENGTH_SHORT).show();
            }
        });
    }
...
//                startActivity(intent);
            ...
            public void onFailure(@NonNull Exception e) {
                Log.e("OnFail", "" + e);
                Toast.makeText(MLkitActivity.this, "Something went wrong! " + e, Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    private void fromRemoteModel() {
        ...
        remoteModel = new FirebaseAutoMLRemoteModel.Builder("sample").build();
        ...
        FirebaseModelManager.getInstance().download(remoteModel, conditions)
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        CropImage.activity().start(MLkitActivity.this); // open image crop activity
                    }
                });
    }
